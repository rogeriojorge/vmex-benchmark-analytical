...
def main(argv=None):
    ...
    run_id, out = reserve_run_directory(args.output_parent, f"{parent['run_id']}-floor-" + __import__("datetime").datetime.now(__import__("datetime").timezone.utc).strftime("%Y%m%dT%H%M%SZ"))
