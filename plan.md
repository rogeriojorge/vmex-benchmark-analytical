...
|---|---|---|
| P0 | Partial | Public repo and required source pins exist; 504 code/config ledger entries, 16 partial reviews. Complete semantic source/test review and reproducible environment metadata. |
...
| P10 | Partial | Reference, axisymmetric, integer 3-D projection/loose-root, short warm trajectory, force-localization and constraint-switch figures generated and inspected; matched performance work remains. |
