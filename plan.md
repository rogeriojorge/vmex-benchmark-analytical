...
|---|---|---|
| P0 | Partial | Public repo and required source pins exist; DESC default-branch review checkout now pinned at `4f48720`. The existing ledger has 504 code/config entries and 17 partial reviews; DESC has only a targeted interface read. Complete semantic source/test review and reproducible environment metadata. |
...
| P10 | Partial | Reference, axisymmetric, integer 3-D projection/loose-root, short warm trajectory, force-localization, constraint-switch, gauge-scan and gauge-surface figures generated and inspected; matched performance work remains. |
