...
|---|---|---|
| P0 | Partial | Public repo and required source pins exist; 504 code/config ledger entries, 17 partial reviews. Complete semantic source/test review and reproducible environment metadata. |
